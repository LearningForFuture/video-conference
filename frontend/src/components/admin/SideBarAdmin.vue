<template>
  ...
  <nav class="side-nav">
    ...
    <ul>
      ...
      <li>
        <a
          href="side-menu-light-inbox.html"
          class="side-menu"
        >
          <div class="side-menu__icon"><i data-feather="inbox" /></div>
      ...
      <li>
        <a
          ...
          class="side-menu"
        >
          <div class="side-menu__icon"><i data-feather="hard-drive" /></div>
      ...
      <li>
        <a
          ...
          class="side-menu"
        >
          <div class="side-menu__icon"><i data-feather="credit-card" /></div>
          <div class="side-menu__title">Point of Sale</div>
        </a>
      </li>
      <li>
        <a
          href="side-menu-light-chat.html"
          class="side-menu"
        >
          <div class="side-menu__icon">
      ...
      <li>
        <a
          href="side-menu-light-post.html"
          class="side-menu"
        >
          <div class="side-menu__icon"><i data-feather="file-text" /></div>
          <div class="side-menu__title">Post</div>
        </a>
      </li>
      <li>
        <a
          href="side-menu-light-calendar.html"
          class="side-menu"
        >
          <div class="side-menu__icon"><i data-feather="calendar" /></div>
      ...
      <li>
        <a
          ...
          class="side-menu"
        >
          <div class="side-menu__icon"><i data-feather="edit" /></div>
          <div class="side-menu__title">
            Crud
            <div class="side-menu__sub-icon">
              <i data-feather="chevron-down" />
      ...
      <li>
        <a
          ...
          class="side-menu"
        >
          <div class="side-menu__icon"><i data-feather="users" /></div>
          <div class="side-menu__title">
            Users
            <div class="side-menu__sub-icon">
              <i data-feather="chevron-down" />
      ...
      <li>
        <a
          ...
          class="side-menu"
        >
          <div class="side-menu__icon"><i data-feather="trello" /></div>
          <div class="side-menu__title">
            Profile
            <div class="side-menu__sub-icon">
              <i data-feather="chevron-down" />
      ...
      <li>
        <a
          ...
          class="side-menu"
        >
          <div class="side-menu__icon"><i data-feather="layout" /></div>
          <div class="side-menu__title">
            Pages
            <div class="side-menu__sub-icon">
              <i data-feather="chevron-down" />
        ...
        <ul class="">
            ...
            <ul class="">
              <li>
                <a
                  ...
                  class="side-menu"
                >
                  <div class="side-menu__icon"><i data-feather="zap" /></div>
                  <div class="side-menu__title">Layout 1</div>
                </a>
              </li>
              <li>
          ...
          <li>
            <a
              href="login-light-register.html"
              class="side-menu"
            >
              <div class="side-menu__icon"><i data-feather="activity" /></div>
          ...
          <li>
            <a
              href="main-light-error-page.html"
              class="side-menu"
            >
              <div class="side-menu__icon"><i data-feather="activity" /></div>
      ...
      <li>
        ...
        <ul class="">
          ...
          <li>
            <a
              href="side-menu-light-button.html"
              class="side-menu"
            >
              <div class="side-menu__icon"><i data-feather="activity" /></div>
          ...
          <li>
            <a
              href="side-menu-light-alert.html"
              class="side-menu"
            >
              <div class="side-menu__icon"><i data-feather="activity" /></div>
          ...
          <li>
            <a
              href="side-menu-light-tooltip.html"
              class="side-menu"
            >
              <div class="side-menu__icon"><i data-feather="activity" /></div>
          ...
          <li>
            <a
              href="side-menu-light-dropdown.html"
              class="side-menu"
            >
              <div class="side-menu__icon"><i data-feather="activity" /></div>
          ...
          <li>
            <a
              href="side-menu-light-icon.html"
              class="side-menu"
            >
              <div class="side-menu__icon"><i data-feather="activity" /></div>
      ...
      <li>
        <a
          ...
          class="side-menu"
        >
          <div class="side-menu__icon"><i data-feather="sidebar" /></div>
          <div class="side-menu__title">
            Forms
            <div class="side-menu__sub-icon">
              <i data-feather="chevron-down" />
        ...
        <ul class="">
          ...
          <li>
            <a
              href="side-menu-light-tail-select.html"
              class="side-menu"
            >
              <div class="side-menu__icon"><i data-feather="activity" /></div>
          ...
          <li>
            <a
              href="side-menu-light-wysiwyg-editor.html"
              class="side-menu"
            >
              <div class="side-menu__icon"><i data-feather="activity" /></div>
      ...
      <li>
        ...
        <ul class="">
          <li>
            <a
              href="side-menu-light-chart.html"
              class="side-menu"
            >
              <div class="side-menu__icon"><i data-feather="activity" /></div>
          ...
          <li>
            <a
              href="side-menu-light-slider.html"
              class="side-menu"
            >
              <div class="side-menu__icon"><i data-feather="activity" /></div>
          ...
          <li>
            <a
              href="side-menu-light-image-zoom.html"
              class="side-menu"
            >
              <div class="side-menu__icon"><i data-feather="activity" /></div>
...
export default {
  ...
  methods: {
    checkNavigationDuplicated(path) {
      return this.$router.currentRoute.fullPath !== path;
    },
    navigateHomePage() {
      let userPagePath = "/admin/users";
      if (this.checkNavigationDuplicated(userPagePath)) {
        this.$router.push({ path: userPagePath });
      }
    },
    navigateRoomPage() {
      let roomPagePath = "/admin/rooms";
      if (this.checkNavigationDuplicated(roomPagePath)) {
        this.$router.push({ path: roomPagePath });
      }
    },
  },
};
