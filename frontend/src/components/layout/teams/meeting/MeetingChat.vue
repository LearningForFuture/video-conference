<template>
  <div class="meeting-chat">
    <div class="container">
      <div id="header-chat" class="row justify-content-between">
        <h3>Meeting Chat</h3>
      ...
      <div class="row">
        <div class="chat-body">
          <div class="message">
            <perfect-scrollbar>
              <div
                v-for="(message, messageId) in getAllMessages"
                :key="messageId"
              >
                  ...
                  <div class="row m-0 mw-100">
                    <a class="avatar">
                      <img
                        :src="
                          ...
                          message.fullName +
                          '&size=200&background=random&rounded=true'
                        "
                        alt="avatar"
                      />
                    </a>
                    <div class="chat-content">
                      <div class="d-flex">
                        ...
                        <time
                          class="ml-2"
                          v-text="formatTimChat(message.createdAt)"
                        />
                      </div>
      ...
      <div id="chat-message-field" class="row">
        <div
          id="message-text"
          ref="messageField"
          contenteditable
...
export default {
  ...
  mounted() {
    document.getElementById("chat-message-field").style.width =
      document.querySelector(".meeting-chat .container").offsetWidth + "px";
    let maxHeight =
      document.querySelector("section").offsetHeight -
      document.getElementById("chat-message-field").offsetHeight -
      20 -
      document.getElementById("header-chat").offsetHeight -
      40;
    document.querySelector(".chat-body .message").style.maxHeight =
      maxHeight + "px";
  ...
  methods: {
    ...
    onConnected() {
      ...
      this.stompClient.subscribe(
        "/topic/meeting/" + this.getMeetingId + "/chat",
        this.onMessageReceived
      );
      this.stompClient.subscribe(
        "/user/topic/meeting/" + this.getMeetingId + "/chat",
        this.onMessageReceived
      );
    },
    ...
    formatTimChat(time) {
      ...
      return (
        ...
        "/" +
        this.zeroPadding(date.getDay(), 2) +
        " " +
